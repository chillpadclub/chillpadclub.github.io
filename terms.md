...
Все платежи обрабатываются нашими доверенными партнерами, как указано в наших Условиях обслуживания. Эти партнеры имеют доступ к платежным данным исключительно для обработки платежей и предотвращения мошенничества.

Данные для коммуникации
Данные электронной почты, когда вы обращаетесь к нам за поддержкой

Информация об устройстве, если это необходимо для решения технических проблем

Ограниченные данные из онлайн-чата (ОС, тип браузера)

Данные об использовании
Информация о том, какие сервисы и функции BlancVPN вы используете и как

Журналы доступа к веб-сайту (тип браузера, ОС, реферальные URL) для анализа и улучшения нашего сайта

Отчеты о сбоях и диагностические данные для улучшения сервисов

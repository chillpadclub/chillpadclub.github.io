...
Тестовый период - период бесплатного использования Сервиса в течение 3 дня; \
Подписка - платный доступ к Сервису на определенный период времени; \
Ключ - ключ доступа к Сервису, приобретаемый в Боте; \
Shadowsocks и Vless - програмные протоклы связи, обсепечиавющие доступ к сети интернет. \

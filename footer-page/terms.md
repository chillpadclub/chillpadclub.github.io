...
Сайт - страница freedom.chillpad.club, опубликованная в сети интернет; \
...
Тарифы - тарифные планы на подключение к VPN, опубликованные в Боте; \
...
Ключ - ключ доступа к Сервису, приобретаемый в Боте; \
